...
void ImGui::Scrollbar(ImGuiAxis axis)
{
    ...
    window->DrawList->AddRectFilled(bb.Min + ImVec2(0, 5), bb.Max, GetColorU32(ImGuiCol_ScrollbarBg), window->WindowRounding, window_rounding_corners);
    ...
    window->DrawList->AddRectFilled(grab_rect.Min + ImVec2(0, 2), grab_rect.Max + ImVec2(0,3), grab_col, style.ScrollbarRounding);
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
        ...
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), ImColor(7, 129, 227, 255));
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power)
{
    ...
    {
        // slider grab
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(2, 7), grab_bb.Max, ImColor(7, 129, 227, 255), style.FrameRounding);
    }
    // Display value using user-provided display format so user can add prefix/suffix/decorations to the value.
    char value_buf[64];
    const char* value_buf_end = value_buf + DataTypeFormatString(value_buf, IM_ARRAYSIZE(value_buf), data_type, v, format);
