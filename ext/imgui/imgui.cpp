...
ImGuiStyle::ImGuiStyle()
{
    ...
    ScrollbarSize           = 2.5f;            // Width of the vertical scrollbar, Height of the horizontal scrollbar
    ...
    if (first_begin_of_the_frame)
    {
        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoTitleBar))
            {
                ...
                window->DrawList->AddRectFilled(title_bar_rect.Min + ImVec2(0, 20), title_bar_rect.Max , ImColor(7, 129, 227, 255));
            }
